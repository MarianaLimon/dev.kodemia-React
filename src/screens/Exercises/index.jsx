...
//           <div className="card bg-primary mx-lg-4 mb-4">
//             <div className="card-body">
//               <h1 className="text-white text-end fw-bold pb-3 p-lg-4">VISA</h1>
//               <h3 className="text-white text-center pb-2">
//                 {Item1}&nbsp;&nbsp;{Item2}&nbsp;&nbsp;{Item3}&nbsp;&nbsp;{Item4}
//               </h3>
//               <div className="d-flex justify-content-between px-lg-4 pb-1">
...
// Se genero una lista de mascotas
